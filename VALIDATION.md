...
## 백엔드 변경 (라이브러리 main, 105 미배포)

- `content.insert.viewbox {headText: ""}` 가 제목 없는 보기박스를 만든다(#1598/PR #1599). 배포 전까지 105 는 옛 동작(3단계 절차)이다.
- `item.choice.populate` 선택지 2000자(#1600/PR #1601). 배포 전까지 105 는 200자.
- 스킬 문서는 105 배포본 기준으로 적혀 있으며 배포 뒤 갱신한다.
